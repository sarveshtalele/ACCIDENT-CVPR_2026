...
## 12. Upload Commands History

The following commands were used to upload `Version10` and `Version11` folders to this repository:

1. Clone the repository:
   ```bash
   git clone https://github.com/sarveshtalele/ACCIDENT-CVPR_2026.git
   ```
2. Copy the folders into the repository (assuming they are in the parent directory):
   ```bash
   cp -r Version10 Version11 ACCIDENT-CVPR_2026/
   ```
3. Navigate to the repository directory:
   ```bash
   cd ACCIDENT-CVPR_2026
   ```
4. Add the folders to git:
   ```bash
   git add Version10 Version11
   git add README.md
   ```
5. Commit the changes:
   ```bash
   git commit -m "Upload Version10 and Version11 data folders"
   ```
